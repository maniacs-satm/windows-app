...
// Licensed under the MIT license. See LICENSE file in the project root (https://github.com/dotMorten/WindowsStateTriggers) for full license information.

using Windows.Foundation.Metadata;
using Windows.UI.Xaml;

namespace wallabag.Common.VisualStateTriggers
{
    /// <summary>
