...
namespace wallabag.Views
{
    public sealed partial class ContentPage : Page
    {
        ...
        private void ItemGridView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            NavigationService.Navigate(typeof(SingleItemPage), clickedItem.Model.Id.ToString());
        }
        ...
        private void SearchBox_QuerySubmitted(AutoSuggestBox sender, AutoSuggestBoxQuerySubmittedEventArgs args)
        {
            if (args.ChosenSuggestion != null)
            {
                ...
                NavigationService.Navigate(typeof(SingleItemPage), id.ToString());
            }
        ...
        private void AddItemButton_Click(object sender, RoutedEventArgs e)
        {
            if (Window.Current.Bounds.Width <= 500 || Helpers.IsPhone)
                NavigationService.Navigate(typeof(AddItemPage));
            else
